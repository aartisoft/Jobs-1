...
public class CategoryWiseFragment extends Fragment {
    ...
    public static List<Item> categoryList;
    LinearLayout lError;
    TextView txtError1;
    ...
    public static CategoryWiseFragment newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        MainActivity.homePagePosition = U.CATEGORY_PAGE;
    ...
    private void showJSON(String json) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                catItem.setId(jo.getInt("id"));
                catItem.setItem(jo.getString("job-cat"));
                catItem.setCount(jo.getString("jobCount"));
                categoryList.add(catItem);
            }
            setCategory(categoryList, fblLay);
            progressBar.setVisibility(View.GONE);
                ...
                tv.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (fragmentManager != null) {
                            ...
                            JobListFragment cat = JobListFragment.newInstance(SU.CATEGORY, "", "",
                                    "", "", "", "", "" + tv.getId(), "", "1");
