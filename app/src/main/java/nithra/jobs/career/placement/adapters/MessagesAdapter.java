...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    private void applyProfilePicture(MyViewHolder holder, Notifications message) {
        /*if (!TextUtils.isEmpty(message.getUrl())) {
            Glide.with(mContext).load(message.getUrl())
                    .thumbnail(0.5f)
                    .crossFade()
            ...
            holder.imgProfile.setImageResource(R.drawable.nithra);
    ...
    private void applyImportant(MyViewHolder holder, Notifications message) {
    ...
    private void applyReadStatus(MyViewHolder holder, Notifications message) {
        if (message.getIsclose() == 1) {
           /* holder.from.setTypeface(null, Typeface.NORMAL);
            holder.subject.setTypeface(null, Typeface.NORMAL);
            holder.from.setTextColor(ContextCompat.getColor(mContext, R.color.subject));
            holder.subject.setTextColor(ContextCompat.getColor(mContext, R.color.message));*/
            holder.lBackground.setBackgroundColor(Color.parseColor("#FFFFFF"));
        } else {
